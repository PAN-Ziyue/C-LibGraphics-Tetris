 ...
 * in the current 
 and size.  The current point is updated
 ...
 * -----------------------------
 * This function returns the current InterfaceID of the erase mode flag.
 */
...
/*
 * Functions: SaveGraphicsInterfaceID, RestoreGraphicsInterfaceID
 * Usage: SaveGraphicsInterfaceID();
 *        . . . graphical operations . . .
 *        RestoreGraphicsInterfaceID();
 * ---------------------------------------------------
 * The SaveGraphicsInterfaceID function saves the current graphics
 * InterfaceID (the current pen position, the font, the point size,
 * and the erase mode flag) internally, so that they can be
 * restored by the next RestoreGraphicsInterfaceID call.  These two
